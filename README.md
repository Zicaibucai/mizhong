...
面向全球市场的 B2B 沙发辅料企业官网。定位为**沙发及软体家具辅料供应商、采购与供应链服务伙伴**，覆盖五金连接件、弹簧支撑、松紧带、无纺布、填充与包装装配辅料。

英文名：**Mizhong New Materials Co., Ltd.**，集中配置于 `src/lib/site-config.ts`。
...
- [x] 公司名称「米众新材料有限公司 / Mizhong New Materials Co., Ltd.」，集中配置
