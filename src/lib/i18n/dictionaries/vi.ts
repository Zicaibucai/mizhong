...
export const vi: Dict = {
  ...
  products: {
    ...
    categories: [
      ...
      { name: 'Khóa kéo & nút', desc: 'Khóa kéo, nút và phụ kiện cài cho may mặc.' },
      { name: 'Thun & dây rút', desc: 'Dây thun, dây rút và các loại dây chức năng.' },
      { name: 'Ren & viền trang trí', desc: 'Ren, ruy băng và viền trang trí.' },
      { name: 'Bao bì', desc: 'Phụ kiện đóng gói và vật liệu trưng bày.' },
    ],
  ...
  quality: {
    ...
    certificatesNote: 'Chi tiết chứng nhận sẽ được công bố khi công ty xác nhận.',
    certificatesPlaceholder: 'Chứng nhận — chờ xác nhận',
  },
  inquiry: {
    eyebrow: 'Bắt đầu dự án',
    title: 'Bạn có yêu cầu nào không?',
    subtitle:
      'Cho chúng tôi biết về sản phẩm, thông số và số lượng, chúng tôi sẽ phản hồi với giá và thời gian giao hàng.',
